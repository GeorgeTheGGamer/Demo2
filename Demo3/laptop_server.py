...
def main():
    ...
    cv2.resizeWindow("Front AI Camera", 800, 600)
    cv2.resizeWindow("Rear Backup Camera", 800, 600)
    cv2.moveWindow("Front AI Camera", 0, 0)
    cv2.moveWindow("Rear Backup Camera", 0, 640)
    ...
    while True:
        ...
        if g.is_running:
            ...
            cv2.imshow("Front AI Camera", cv2.resize(front_display, (800, 600)))
            cv2.imshow("Rear Backup Camera", cv2.resize(rear_display, (800, 600)))
